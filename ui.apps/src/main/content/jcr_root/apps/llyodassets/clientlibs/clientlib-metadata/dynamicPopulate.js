(function ($document, $) {
   ...
   // var internationalWealth = ['Value1','test value','Value3'];
    ...
    var pathofMetadata = urlParams.get('item')+"/jcr:content/metadata.json";
           ...
           if(index == "agency")
            {
                ...
                if ($.inArray(agencyValue, values) != -1){
                    $("coral-select[name='./jcr:content/metadata/lbg:agency']").append('<coral-select-item value="'+agencyValue+'" trackingelement="" selected="">'+agencyValue+'</coral-select-item>')
                }
